...
local lib = loadstring(game:HttpGet("https://pastebin.com/raw/FFmGAG5K"))();
lib:MakeSection("Main")
lib:MakeToggle("Aimbot", function(aimbottoggle)
if aimbottoggle == true then
    _G.AimbotEnabled = true
elseif aimbottoggle == false then
    _G.AimbotEnabled = false
end
end)

lib:MakeToggle("Triggerbot", function(toggletrigger)
       if toggletrigger == true then
        getgenv().settings.Enabled = true
    elseif toggletrigger == false then
...
_G.CircleRadius = 45 -- The radius of the circle / FOV.
