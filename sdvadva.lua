rconsoleclear()
rconsolename("Trainer")
rconsoleprint("@@MAGENTA@@")
rconsoleprint("Version 1.4")
wait(1)
rconsoleclear()
rconsoleprint("Made by bubo#4439")
wait(1)
rconsoleprint("Loaded... Toggle Trainer With Z")
wait(3)
rconsoleclear()
rconsoleprint("Discord is bubo#4439 if any errors occur")
local loaded = true
...
local _aimsp_settings; _aimsp_settings = {
    ...
    headshot_odds = {
        ...
        func = function() -- if use_odds is false, this function won't be called
            local chance = 40 -- chance to aim on the head out of 100
    ...
    smoothness = 6, -- anything over 5 = aim assist,  1 = lock on (using 1 might get u banned)
    fov_size = 120; -- <450 = safezone
